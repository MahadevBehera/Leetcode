# [Nth Fibonacci Using Recursion](https://www.geeksforgeeks.org/problems/fibonacci-using-recursion/1)
## Easy
Given a number n, return the nth Fibonacci number.
Note: If F(n) is nth fibonacci number then , F(n) = F(n-1) + F(n-2) ; where F(0) = 0 and F(1) = 1Example:
Input: n = 3
Output: 2
